...
class MPCActionTerm(ActionTerm):
    ...
    def __init__(self, cfg: "MPCActionCfg", env: ManagerBasedEnv):
        ...
        self.controllers = VectorPool(
            instances=self.num_envs,
            cls=self.cfg.robot_interface,
            **self.cfg.robot_interface_kwargs
        )
...
class MPCActionCfg(ActionTermCfg):
    ...
    robot_interface: type[sim2real.Sim2RealInterface] = MISSING  # type: ignore
    """Interface to the robot
    """

    robot_interface_kwargs: dict[str, Any] = {}
    """Kwargs to pass to robot_interface
    """
